...
def original_backward_chaining_grounding_one_rule_with_domains(
    ...
    for q in queries:
      ...
      for ground_vars in product(*[domains[vd[1]].constants
...
class OriginalBackwardChainingGrounder(Engine):
