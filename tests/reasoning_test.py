from ns_lib.grounding.backward_chaining_grounder import BackwardChainingRule
from ns_lib.logic.commons import Atom, Predicate, Domain
from ns_lib.data import Dataset
import ns_lib as ns
from ns_lib.layers import LatentWorldSemanticReasoningLayerStacked
import numpy as np
