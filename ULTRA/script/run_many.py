...
default_finetuning_config = {
    ...
    # standard ones (10)
    "FB15k237FullTransductive": (15,'null'),
    "Kinship_Transductive": (15, 'null'),
    'KinshipFullTransductive': (15,'null'),
    "CountriesTransductive": (60, 'null'),
    "countries": (1, 'null'),
    "CoDExSmall": (1, 4000),
    "CoDExMedium": (1, 4000),
    "CoDExLarge": (1, 2000),
...
if __name__ == "__main__":
    ...
    for graph in datasets:
        ...
        for i in range(args.repeats):
            ...
            print('\n\n\ntrain_data num_relations', train_data.num_relations, 'train data num_nodes', train_data.num_nodes)
            model = Ultra(
