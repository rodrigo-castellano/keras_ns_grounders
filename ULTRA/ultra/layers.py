...
class GeneralizedRelationalConv(MessagePassing):
    ...
    def forward(self, input, query, boundary, edge_index, edge_type, size, edge_weight=None):
        ...
        # If the relation is a tensor, print the shape of the tensor, else print the relation 
        if self.dependent:
        ...
        # print('**********************************')                   
        output = self.propagate(edge_index, size=size, input=input, relation=relation, boundary=boundary,
