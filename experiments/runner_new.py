...
class ExperimentConfig:
    ...
    def parse_args(self):
        ...
        parser.add_argument("--load_model", default = None, help="load model ckpt",nargs='+')
        parser.add_argument("--load_kge", default = None, help="load kge ckpt",nargs='+')
        ...
        if args.load_model: self.load_model_ckpt = args.load_model
        if args.load_kge: self.load_kge_ckpt = args.load_kge
