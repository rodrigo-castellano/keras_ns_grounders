...
if __name__ == '__main__':
    ...
    epochs: int = 100
    EARLY_STOPPING = True
    DATASET_NAME = ['FB15k237'] # ['ablation_d','ablation_d2','ablation_d3'] #['countries_s2','countries_s3','nations','kinship_family','pharmkg_small','pharmkg_full','wn18rr','nations','FB15k237']
