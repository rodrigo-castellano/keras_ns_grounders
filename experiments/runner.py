...
if __name__ == '__main__':
    ...
    epochs: int = 100
    EARLY_STOPPING = True
    DATASET_NAME = ['ablation_d2'] #['countries_s2','countries_s3','nations','kinship_family','pharmkg_small','pharmkg_full','wn18rr','nations','FB15k237']
    GROUNDER = ['backward_1_2'] # ['backward_0_1','backward_0_2','backward_0_3','backward_1_1','backward_1_2','backward_1_3',
