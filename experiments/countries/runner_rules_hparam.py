...
if __name__ == '__main__':
    ...
    GROUNDER = ['backward_prune_3','backward_1','backward_2','backward_3','domainbody','full'] # ['known','backward_1','backward_2','backward_3','domainbody','full'] 
    KGE = ['complex']  # ["distmult", "transe","complex", "rotate"]
    MODEL_NAME = ['sbr','no_reasoner','sbr','rnm','dcr','r2n']# ['rnm','dcr','r2n','sbr','gsbr','cdcr','no_reasoner']  'gsbr' 'cdcr' not published yet
