...
if __name__ == '__main__':
    ...
    GROUNDER = ['backward_prune_1','backward_1','backward_prune_2','backward_2','backward_prune_3','backward_3','domainbody','full'] # ['known','backward_1','backward_2','backward_3','domainbody','full'] 
