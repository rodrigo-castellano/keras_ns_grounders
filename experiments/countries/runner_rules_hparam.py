...
if __name__ == '__main__':
    ...
    epochs: int = 120
    assert epochs > 0
    DATASET_NAME = ['pharmkg_supersmall'] #['kinship_family_small','pharmkg_supersmall',] #['countries_s1','countries_s2','countries_s3','pharmkg_supersmall','nations','kinship_family_small'] 
