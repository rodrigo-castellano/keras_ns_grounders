...
#         self.output_layer = tf.keras.models.Sequential([tf.keras.layers.Dense(64, activation='relu'),tf.keras.layers.Dense(1, activation=None)])
#         # copy the weights from the 
...
#     def call(self, inputs,constant_embeddings,predicate_embeddings):
