...
def evaluate_and_store_ranks(model, data_gen_test, seed, args, metric):
    ...
    os.makedirs('./experiments/ranks', exist_ok=True)
    output_file = f'./experiments/ranks/{args.run_signature}_seed_{seed}.txt'
    ...
    if output_file:
        ...
        with open(f'./experiments/ranks/ranks_{args.run_signature}_seed_{seed}_{metric}.txt', 'w') as f:
